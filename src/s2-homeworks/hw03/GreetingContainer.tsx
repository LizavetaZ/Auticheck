...
const GreetingContainer: React.FC<GreetingContainerPropsType> = ({
    ...
    const totalUsers: number = users.length // need to fix было 0
    const lastUserName: string | undefined = users.length > 0 ? users[users.length-1].name : undefined// need to fix было 'some name'
